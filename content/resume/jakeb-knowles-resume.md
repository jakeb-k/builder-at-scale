...
### Software Engineer / Technical Lead - Simpro Software
...
Apr 2024 - Jun 2025 | Brisbane, QLD

- Built and maintained full-stack business applications across Laravel, Vue, React, Next.js, React Native, PHP, JavaScript, TypeScript, SQL, and Tailwind CSS.
...
- Building an AI-powered goal-setting app that turns natural-language conversations into structured plans, timelines, calendar events, progress logs, and point-based goal tracking.
- Developed with Expo, React Native, Laravel, SQLite, Zustand, NativeWind, OpenAI API, Pest, Jest, GitHub Actions, and GitHub Projects.
- Designed the product around conversational planning, editable milestones, progress visibility, and lightweight accountability loops.
